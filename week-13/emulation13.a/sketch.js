...
let sizeDiff = .2;//amount each orbit increases than previous
...
function setup() {
  ...
  rotationGradientSlider = createSlider(0, rotationGradient*5, rotationGradient, 0.000001)// user adjustment
...
class Star {//stars for each star
  constructor(majorAxisLen) {//each star's orbit
